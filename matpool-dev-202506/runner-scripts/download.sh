...
mkdir -p /home/root/ComfyUI/user/default/ComfyUI-Manager

cat <<EOF > /home/root/ComfyUI/user/default/ComfyUI-Manager/config.ini
[default]
channel_url = https://gh-proxy.com/https://raw.githubusercontent.com/ltdrdata/ComfyUI-Manager/main
EOF

cat <<EOF > /home/root/ComfyUI/user/default/ComfyUI-Manager/channels.list
